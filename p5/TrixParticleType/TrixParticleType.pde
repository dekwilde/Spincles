TrixParticle trixParticleBAD;
TrixParticle trixParticleGOOD;
ArrayList particles;

void setup(){
  size(320, 480);
  trixParticleBAD = new TrixParticle("bad");
  trixParticleGOOD = new TrixParticle("good");
}

void draw(){
  background(#FFCC00);
  trixParticleBAD.draw();
  trixParticleGOOD.draw();
 
}

void mousePressed(){
  trixParticleBAD.num = 0;
  trixParticleGOOD.num = 0;
}
