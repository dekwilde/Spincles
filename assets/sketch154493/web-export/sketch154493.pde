/* @pjs font="cubic.ttf, pixelart.ttf"; */

/* OpenProcessing Tweak of *@*http://www.openprocessing.org/sketch/154493*@* */
/* !do not delete the line above, required for linking your tweak if you upload again */
public PGraphics pg;
public PFont fontText;
final int nbPartsPerLetter = 80;
...
void process(String p_word)
{
  ...
  fontText = loadFont("cubic.ttf");
  
  pg = createGraphics(width, height);
  pg.beginShape();
  pg.textFont(fontText, 72);
  pg.textSize(72);
  pg.fill(textCol);
