var soundMagnetic,
	...
	soundTouchTimer = new Howl({urls: [baseURL+'glitch.mp3', baseURL+'glitch.ogg', baseURL+'glitch.wav']});
	soundLoopBG 	= new Howl({urls: [baseURL+'loop1.mp3', baseURL+'loop1.ogg', baseURL+'loop1.wav']});
	soundStart 		= new Howl({urls: [baseURL+'loopstart.mp3', baseURL+'loopstart.ogg', baseURL+'loopstart.wav']});
